...
import pt.lighthouselabs.obd.commands.control.VINCommand;
...
public class MainActivity extends RoboActivity implements ObdProgressListener, View.OnClickListener {
  ...
  //Firebase PitstopWeb = new Firebase("https://pitstop-remote.firebaseio.com/Scans");
  Button get_DTC;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    get_DTC=(Button) findViewById(R.id.button);
      get_DTC.setOnClickListener(this);
  ...
  private void queueCommands() {
    if (isServiceBound) {
      ...
      final ObdCommandJob vin_num = new ObdCommandJob(new VINCommand());
